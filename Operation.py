...
#     def __init__(self,in_channels,channels,stride,shape,affine):
#         super(Channel_Attention,self).__init__()
#         self.shape = shape
#         self.affine = affine
#         self.avg_pool = nn.AdaptiveAvgPool2d(1)
#         self.max_pool = nn.AdaptiveMaxPool2d(1)
#         self.fc1 = nn.Conv2d(in_channels,in_channels//4,1,stride=stride,bias = False)
#         self.relu1 = nn.ReLU()
#         self.fc2 = nn.Conv2d(in_channels//4,channels,1,bias = False)
#         self.sigmoid = nn.Sigmoid()
#     def forward(self,x):
